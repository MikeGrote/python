#Anayse
#python -m zeep http://timepunch.incept4.local/timepunch/Api/TpReporting.svc?WSDL
...
client = Client('http://timepunch.incept4.local/timepunch/Api/TpReporting.svc?WSDL')
...
#     ns2:UserSearchDto(Page: xsd:int,
#      PageSize: xsd:int, 
#      UsePaging: xsd:boolean, 
#      IsInGroupIds: ns3:ArrayOfguid, 
#      IsNotInGroupIds: ns3:ArrayOfguid, 
#      IsUserDeleted: xsd:boolean, 
#      LogonName: xsd:string, 
#      UserCode: xsd:string, 
#      UserFiltering: ns6:UserFiltering, 
#      UserIds: ns3:ArrayOfguid, 
#      GenericSearch: xsd:string)


search_type = client.get_type('ns13:TimeEntrySearchDto')
search = search_type(UsePaging = False,  
                    ...
                    ShowWeekdays = True,
                    LogonTime = '2021-10-25T00:00:00',
                    LogoffTime = '2021-10-25T00:00:00',
                    ReportTitle = 'Test',
                    Confidentiality = 'Undefined')

#response_type = client.get_type('ns8:TimeEntrySearchPayment')

response = client.service.GetReportTimeEntriesUserBased(auth,search)
#print(response)
